...
//--------------------------------------------------------------------------------
function calculateWpDamageColor(tree){
   // rev(colorRampPalette(c("white", "gray", "black"))(7))
   //[1] "#000000" "#3F3F3F" "#7E7E7E" "#BEBEBE" "#D3D3D3" "#E9E9E9" "#FFFFFF"
 
    // R:  rev(colorRampPalette(c("green", "gray", "black"))(7))
    //var colors = ["#000000","#3F3F3F","#7E7E7E","#BEBEBE","#7ED37E","#3FE93F","#00FF00"]
    var colors = ["#000000", "#3F3F3F", "#7E7E7E", "#BEBEBE", "#D3D3D3", "#E9E9E9", "#FFFFFF"]
    colors = ["#FFFFFF", "#FFCCCC", "#FF9999", "#FF6565", "#FF3232", "#FF0000"]
    // colorRampPalette(c("lightgray", "black"))(6)
    colors = ["#D3D3D3", "#A8A8A8", "#7E7E7E", "#545454", "#2A2A2A", "#000000"]

    var wpScore = tree["wpDamage"]
    var breaks = [2,3,4,5,6 ]
    // R:round(seq(0,3,length.out=7), digits=2)
    for(let i=0; i < breaks.length; i++){
       if(wpScore < breaks[i]){
          return(colors[i])
